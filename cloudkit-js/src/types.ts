...
export const RecordType = {
  todoItem: "CD_TodoItem",
  todoAttachment: "CD_TodoAttachment",
  reminder: "CD_Reminder",
  anniversaryItem: "CD_AnniversaryItem",
} as const;
...
export type CloudKitFieldValue =
  ...
  | { value: number; type: "INT64" }
  | { value: number; type: "DOUBLE" }
  | { value: string; type: "TIMESTAMP" }
  | { value: string; type: "REFERENCE" }
  | { value: string; type: "ASSET" }
  | { value: string; type: "BYTES" };
