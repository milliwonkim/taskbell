...
#ifndef TASKBELL_SWIFT_H
#define TASKBELL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TaskBell",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
SWIFT_CLASS("_TtC8TaskBell19TaskBellAppDelegate")
@interface TaskBellAppDelegate : NSObject <UIApplicationDelegate>
